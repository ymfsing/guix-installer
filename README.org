...
We also should set proxy for terminal:

#+BEGIN_SRC sh

export http_proxy=http://192.168.1.100:8080
export https_proxy=http://192.168.1.100:8080
export all_proxy=socks5://192.168.1.100:8080
...
guix time-machine --substitute-urls="https://bordeaux.guix.gnu.org https://mirror.sjtu.edu.cn/guix/" -C /mnt/etc/channels.scm -- system init /mnt/etc/config.scm /mnt
